...
(
	...
	inv_module character varying NOT NULL,
	...
	classification_id interger NOT NULL,
...
UPDATE inventory 
SET inv_image = REPLACE (inv_image, 'image', 'images/vehicless'), inv_thumbnail = REPLACE (inv_thumbnail, 'image', 'images/vehicles')
