...
async function getVehicleId(inventoryId) {
  try {
    const data = await pool.query(
...
module.exports = {getClassifications, getInventoryByClassificationId, getVehicleId, addClassification, addInventory, updateInventory, deleteInventory};